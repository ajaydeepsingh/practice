...
# inconsistency, and that somebody must be lying.
# (For the purpose of this challenge, assume that nobody makes mistakes or
# forgets, and if X has met Y, that means Y has also met X.)
#
...
# warmup1([0, 0, 0]) => []
# warmup1([]) => []
# If you want to reorder the sequence as you do this, that's fine. For instance,
# given [4, 0, 0, 1, 3], then you may return [4, 1, 3] or [1, 3, 4] or [4, 3, 1] or any other ordering of these numbers.
#
...
# Given a number N and a sequence of answers, return true if N is greater than
# the number of answers (i.e. the length of the sequence), and false if N is
...
# Given a number N and a sequence in descending order, subtract 1 from each of
# the first N answers in the sequence, and return the result. For instance,
# given N = 4 and the sequence [5, 4, 3, 2, 1], you would subtract 1 from each
# of the first 4 answers (5, 4, 3, and 2) to get 4, 3, 2, and 1.
